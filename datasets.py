...
class MNIST(data.Dataset):
    ...
    def process(self):
        ...
        try:
            os.makedirs(os.path.join(self.root,self.raw_folder))#/data/raw
            os.makedirs(os.path.join(self.root,self.processed_folder))#/data/process
        except:
            pass

        files=os.listdir(os.path.join(self.root,self.raw_folder))#/data/raw
